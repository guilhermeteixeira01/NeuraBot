...
export default function App() {
    ...
    return (
        <>
            <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Orbitron:wght@400;700;900&family=Sora:wght@300;400;600;700&family=JetBrains+Mono:wght@400;700&display=swap');
        ...
        *, *::before, *::after {
        ...
        body {
          background:#07070f; color:#e8e8ff;
          font-family:'Sora','Segoe UI',sans-serif; overflow-x:hidden;
        }
        ...
        .btn-primary {
          ...
          font-family:'Sora',sans-serif; transition:all .2s; letter-spacing:.5px;
        ...
        .btn-outline {
          display:inline-flex; align-items:center; justify-content:center; gap:6px;
          background:transparent; color:#00d4ff; border:1px solid #00d4ff55;
        ...
        .btn-outline:hover { background:#00d4ff11; border-color:#00d4ff; }

        .btn-danger-outline {
          display:inline-flex; align-items:center; justify-content:center; gap:6px;
          background:transparent; color:#ff4466; border:1px solid #ff446655;
          border-radius:8px; padding:10px 20px; font-size:13px; font-weight:600;
          cursor:pointer; font-family:'Sora',sans-serif; transition:all .2s;
        }
        .btn-danger-outline:hover { background:#ff446611; border-color:#ff4466; }

        .btn-icon {
          display:inline-flex; align-items:center; justify-content:center;
          background:#00d4ff0d; color:#00d4ff; border:1px solid #00d4ff33;
          border-radius:8px; width:42px; height:42px; font-size:16px;
          cursor:pointer; transition:all .2s;
        }
        .btn-icon:hover { background:#00d4ff22; border-color:#00d4ff88; box-shadow:0 0 14px #00d4ff33; }

        /* misc */
        .nb-card {
          background:linear-gradient(160deg,#0d0d1a 0%,#0a0a14 100%);
          border:1px solid #00d4ff18; border-radius:14px; overflow:hidden;
        }
        .section-label {
          font-family:'Orbitron',sans-serif; font-size:9px; font-weight:700;
          letter-spacing:.18em; text-transform:uppercase; color:#00d4ff;
          margin-bottom:10px; display:block;
        }

        /* discord markdown */
        .spoiler { background:#0d0d1a; color:transparent; border-radius:3px; padding:0 3px; cursor:pointer; }
        .spoiler:hover { color:#e8e8ff; }
        .d-h1{font-size:2rem;font-weight:700}
        .d-h2{font-size:1.7rem;font-weight:700}
        .d-h3{font-size:1.33rem;font-weight:700}
        .d-h4{font-size:1rem;font-weight:700}
        blockquote { border-left:3px solid #00d4ff44; padding-left:10px; margin:4px 0; color:#8888aa; }
        pre { background:#0a0a14; border:1px solid #00d4ff18; border-radius:6px; padding:10px; margin:4px 0; overflow-x:auto; }
        code { background:#0a0a14; border-radius:4px; padding:0 5px; font-family:'JetBrains Mono',monospace; font-size:.83em; color:#00d4ff; }
        pre code { background:none; padding:0; }
        p { margin:0; display:inline; }

        /* output textarea */
        .output-area {
          width:100%; background:#0a0a14; border:1px solid #00d4ff22; color:#e8e8ff;
          padding:10px 12px; border-radius:8px;
          font-family:'JetBrains Mono',monospace; font-size:11px;
          resize:none; outline:none; min-height:80px; line-height:1.6;
          transition:border-color .2s, box-shadow .2s;
        }
        .output-area:focus { border-color:#00d4ff66; box-shadow:0 0 0 3px #00d4ff14; }

        kbd {
          background:#0a0a14; border:1px solid #00d4ff33; border-radius:4px;
      ...
      `}</style>
            ...
            {/* ══ BODY ════════════════════════════════════════════════════════════════ */}
            <div style={{ display: "flex", minHeight: "calc(100vh - 68px)", position: "relative", zIndex: 2 }}>

                {/* ── LEFT: FORM ────────────────────────────────────────────────────── */}
                <div style={{
                    width: 430, minWidth: 340, overflowY: "auto",
                    background: "rgba(7,7,15,.95)", borderRight: "1px solid #00d4ff14",
                    flexShrink: 0,
                }}>
                                ...
                                {embed.fields.map((field, i) => (
                                    ...
                                    >
                                        <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 8 }}>
                                            ...
                                            <span style={{
                                                fontFamily: "'Orbitron',sans-serif", fontSize: 8,
                                                letterSpacing: ".14em", color: "#00d4ff66",
                                            }}>FIELD {i + 1}</span>
                                        </div>
                                        <InputRow label="Name">
                                        ...
                                        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", paddingLeft: 118, marginTop: 6 }}>
                ...
                <div style={{
                    ...
                    <span className="section-label">● Preview ao vivo</span>
