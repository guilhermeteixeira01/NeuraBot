  ...
  return (
    <div className="login-screen">
      ...
      <div className="login-card">
        ...
        <div className="login-note">Desenvolvido Por <a href="https://github.com/guilhermeteixeira01" target="_blank" rel="noopener noreferrer" style={{ color: 'snow', textDecoration: 'none' }}>Guilherme Teixeira</a></div>
      </div>
    </div>
  );
}
